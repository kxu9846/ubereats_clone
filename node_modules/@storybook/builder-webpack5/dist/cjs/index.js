...
var checkWebpackVersion5 = function (webpackInstance) {
  return (0, _coreCommon.checkWebpackVersion)(webpackInstance, '5.x', 'builder-webpack5');
};
...
var build = async function ({
  ...
  return new Promise(function (succeed, fail) {
    (0, _webpack.default)(config).run(function (error, stats) {
