...
function simulateDOMContentLoaded() {
  var DOMContentLoadedEvent = _global.document.createEvent('Event');

  DOMContentLoadedEvent.initEvent('DOMContentLoaded', true, true);

  _global.document.dispatchEvent(DOMContentLoadedEvent);
}
...
function insertScript($script, callback, $scriptRoot) {
  ...
  if ($scriptRoot) $scriptRoot.appendChild(scriptEl);else _global.document.head.appendChild(scriptEl); // clean-up
...
function simulatePageLoad($container) {
  var $scriptsRoot = _global.document.getElementById(SCRIPTS_ROOT_ID);

  if (!$scriptsRoot) {
    $scriptsRoot = _global.document.createElement('div');
    $scriptsRoot.id = SCRIPTS_ROOT_ID;

    _global.document.body.appendChild($scriptsRoot);
  } else {
