...
exports.default = exports.addArgTypesEnhancer = exports.addLoader = exports.addParameters = exports.addDecorator = void 0;
  ...
  this.storiesOf = function (kind, m) {
    ...
    api.add = function (storyName, storyFn) {
      ...
      if (typeof storyFn !== 'function') {
        throw new Error("Cannot load story \"".concat(storyName, "\" in \"").concat(kind, "\" due to invalid format. Storybook expected a function but received ").concat(_typeof(storyFn), " instead."));
      }
