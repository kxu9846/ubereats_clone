...
var StoryStore = /*#__PURE__*/function () {
  ...
  function StoryStore(params) {
    ...
    this._globals = ((_store$session$get = store.session.get(STORAGE_KEY)) === null || _store$session$get === void 0 ? void 0 : _store$session$get.globals) || {};
  ...
  _createClass(StoryStore, [{
    ...
    value: function sortedStories() {
      ...
      var kindOrder = mapValues(this._kinds, function (_ref25) {
