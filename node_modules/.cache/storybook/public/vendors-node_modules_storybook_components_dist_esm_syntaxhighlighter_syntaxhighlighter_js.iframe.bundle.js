(self["webpackChunkubereats_clone"] = self["webpackChunkubereats_clone"] || []).push([["vendors-node_modules_storybook_components_dist_esm_syntaxhighlighter_syntaxhighlighter_js"],{
...
if (global__WEBPACK_IMPORTED_MODULE_18__.navigator !== null && global__WEBPACK_IMPORTED_MODULE_18__.navigator !== void 0 && global__WEBPACK_IMPORTED_MODULE_18__.navigator.clipboard) {
  copyToClipboard = function copyToClipboard(text) {
    return global__WEBPACK_IMPORTED_MODULE_18__.navigator.clipboard.writeText(text);
  };
} else {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              tmp = global__WEBPACK_IMPORTED_MODULE_18__.document.createElement('TEXTAREA');
              focus = global__WEBPACK_IMPORTED_MODULE_18__.document.activeElement;
              tmp.value = text;
              global__WEBPACK_IMPORTED_MODULE_18__.document.body.appendChild(tmp);
              tmp.select();
              global__WEBPACK_IMPORTED_MODULE_18__.document.execCommand('copy');
              global__WEBPACK_IMPORTED_MODULE_18__.document.body.removeChild(tmp);
              focus.focus();
...
var SyntaxHighlighter = function SyntaxHighlighter(_ref10) {
  ...
  var onClick = function onClick(e) {
    ...
    copyToClipboard(highlightableCode).then(function () {
      setCopied(true);
      global__WEBPACK_IMPORTED_MODULE_18__.window.setTimeout(function () {
