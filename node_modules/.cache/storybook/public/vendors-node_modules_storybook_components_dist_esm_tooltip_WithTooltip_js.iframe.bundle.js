(self["webpackChunkubereats_clone"] = self["webpackChunkubereats_clone"] || []).push([["vendors-node_modules_storybook_components_dist_esm_tooltip_WithTooltip_js"],{
...
var WithToolTipState = function WithToolTipState(_ref4) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_14__.useEffect)(function () {
    ...
    global__WEBPACK_IMPORTED_MODULE_15__.document.addEventListener('keydown', hide, false); // Find all iframes on the screen and bind to clicks inside them (waiting until the iframe is ready)

    var iframes = Array.from(global__WEBPACK_IMPORTED_MODULE_15__.document.getElementsByTagName('iframe'));
    var unbinders = [];
    ...
    return function () {
      global__WEBPACK_IMPORTED_MODULE_15__.document.removeEventListener('keydown', hide);
